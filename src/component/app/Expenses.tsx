...
const Expenses = () => {
    ...
    const creatExpenses = async (values:FormDataType)=>{
        const {data} = await HttpInterceptor.post("/expenses",values )
  ...
  return (
    ...
    >
        <Form onValue={creatExpenses} className="grid grid-cols-2 gap-4">
