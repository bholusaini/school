...
useEffect(()=>{
 ...
 <div className="flex flex-col gap -2 w-full h-full  justify-center items-center"> <h1 className="text-2xl font-semibold text-black">Admission Overview</h1>  <canvas ref={BarChartRef}></canvas></div>
 <div  className="flex flex-col gap -2 w-full h-96 justify-center items-center">  
  <h1 className="text-2xl font-semibold text-black">Payment Status</h1>  <canvas ref={PieChartRef}></canvas></div>   
